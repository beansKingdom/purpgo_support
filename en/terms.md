...
- Pro subscriptions are offered as auto-renewable monthly plans. Prices are as displayed in the App Store.
...
2.6 **Feature Changes:** Prices and features may be adjusted as appropriate. If changes occur, we will notify you prominently within the app. Any subscription period already paid for will not be affected by subsequent price changes.
...
3.2 You shall not reverse engineer, decompile, disassemble, crack, modify, or attempt to extract the source code of the App, nor exploit any program bugs or errors for improper gain.

3.3 You are responsible for keeping your device and data secure. The Developer shall not be liable for any data leakage caused by device loss, theft, unauthorized access, or improper safekeeping of exported data.
...
5.2 By using the App, you acknowledge that you have read and agree to the entire PurpGo Privacy Policy.
...
6.2 Without the express written permission of the Developer, you shall not copy, modify, distribute, rent, lend, sell, sublicense, or create derivative works based on the App or any part thereof.
...
7.4 Any liability arising from your failure to use the App in accordance with this agreement, violation of applicable laws and regulations, or failure to properly safeguard your data shall be borne solely by you.
...
8.2 If you do not agree with the modified terms, you have the right to stop using the App and uninstall it. Your continued use of the App after the modified agreement takes effect constitutes your acceptance of all modified terms.
